...
#  files/libswe-([\d\.]+)\.tar\.gz debian uupdate

# Uncomment to examine an FTP server.
#ftp://ftp.example.com/pub/libswe-(.*)\.tar\.gz debian uupdate

# SourceForge hosted projects.
# http://sf.net/libswe/ libswe-(.*)\.tar\.gz debian uupdate

# GitHub hosted projects.
#opts="filenamemangle=s%(?:.*?)?v?(\d[\d.]*)\.tar\.gz%<project>-$1.tar.gz%" \
#   https://github.com/<user>/libswe/tags \
...
# PyPI.
# https://pypi.debian.net/libswe/libswe-(.+)\.(?:zip|tgz|tbz|txz|(?:tar\.(?:gz|bz2|xz)))

# Direct Git.
# opts="mode=git" http://git.example.com/libswe.git \
